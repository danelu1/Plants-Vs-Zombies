...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.25, 0.44, 0.83)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.1, 0.2, 0.56)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0.98, 0.54, 0.43)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.32, 0.85, 0.12)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.55, 0.34, 0.45)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.1, 0.2, 0.3)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.43, 0.12, 0.67)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.56, 0.8, 0.9)),
        };
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            //VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.25, 0.44, 0.83)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.1, 0.2, 0.56)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.98, 0.54, 0.43)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.32, 0.85, 0.12)),
        };
    ...
    // opposing vertex orientations.
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.25, 0.44, 0.83)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.1, 0.2, 0.56)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.98, 0.54, 0.43)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.32, 0.85, 0.12)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-1.3, 1, 0.2), glm::vec3(0.25f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(-1.9, 2, 0.2), glm::vec3(0.25f));
    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-1, 3, 0.2), glm::vec3(0.25f));

    RenderMesh(meshes["circle"], shaders["VertexColoro"], glm::vec3(-0.2, 4, 0.2), glm::vec3(0.25f));
